...
// Function to calculate and return the result based on the active input
function calculateResult() {
  return activeInput === 1 ? inputs[0] : inputs[1];
}
...
// 	}
	...
	// 	input_0_array.length = 0;
	// } else {
	// }
	// if (input_1_array.length >= 2) {
	// 	input_1_array.length = 0;
	// } else {
	// }

	// input_0_array.push(inputs[0]);
	// script.log("input_0_array = " + input_0_array);

	// input_1_array.push(inputs[1]);
	// script.log("input_1_array = " + input_1_array);
